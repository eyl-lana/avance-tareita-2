...
int main()
{
	...
	leer_archivo(almacenamiento, map_pokedex, map_pokemon, map_id, map_tipo, map_region);
	...
	do{
		...
		switch(opcion){
			...
			case 2: /* Atrapar pokemon */
				pedir_datos(almacenamiento, map_pokedex, map_pokemon, map_id, map_tipo, map_region);
				break;
